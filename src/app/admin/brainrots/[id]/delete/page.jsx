...
import DeleteBrainrotForm from "@/components/Admin/DeleteBrainrotForm";

export default function DeleteBrainrotPage() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm font-urbanist text-gray-600 dark:text-gray-400">
            Are you sure you want to delete {brainrot.name}? This action cannot be undone.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 shadow overflow-hidden sm:rounded-lg border border-gray-200 dark:border-slate-700 transition-colors">
          <div className="px-4 py-6 sm:p-8">
            <DeleteBrainrotForm brainrot={brainrot} />
          </div>
        </div>
      </div>
    </div>
