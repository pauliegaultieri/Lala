...
import TraitsAdminList from "@/components/Admin/TraitsAdminList";

export const metadata = {
  title: "Manage Traits - Admin Dashboard",
  description: "Manage trait modifiers in the Sabrvalues database",
};
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-10">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-pp-mori font-semibold text-gray-900 dark:text-white">
              Manage <span className="text-[#4F46E5] dark:text-[#6366F1]">Traits</span>
            </h1>
          </div>
