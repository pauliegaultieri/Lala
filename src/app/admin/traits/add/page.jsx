...
export const metadata = {
  title: "Add New Trait - Admin Dashboard",
  description: "Add a new trait modifier to the Sabrvalues database",
};

export default async function AddTraitPage() {
  await requireAdmin();
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-12 py-12">
        <div className="mb-10">
          ...
          <h1 className="mt-3 text-[2.25rem] sm:text-[2.5rem] font-pp-mori font-semibold text-[#020617] dark:text-white">
            Add <span className="text-[#4F46E5] dark:text-[#6366F1]">Trait</span>
          </h1>
          <p className="mt-2 text-sm font-urbanist text-gray-600 dark:text-gray-400">
            Create a new trait entry in the database.
          </p>
        </div>
