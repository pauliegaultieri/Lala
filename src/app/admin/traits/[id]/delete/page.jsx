...
import DeleteTraitForm from "@/components/Admin/DeleteTraitForm";

export default function DeleteTraitPage() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-12 py-12">
        <div className="mb-10">
          ...
          <h1 className="mt-3 text-[2.25rem] sm:text-[2.5rem] font-pp-mori font-semibold text-[#020617] dark:text-white">
            Delete <span className="text-red-500">Trait</span>
          </h1>
