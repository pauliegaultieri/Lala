...
export async function GET() {
  try {
    ...
    return NextResponse.json({ mutations, count: mutations.length });
  } catch (error) {
    console.error("Error fetching mutations (admin):", error);
...
export async function POST(request) {
  try {
    ...
    const docRef = await adminDb.collection("mutations").add(data);
