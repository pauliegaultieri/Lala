...
export default function TraitForm({ initialData = null }) {
  ...
  const [formData, setFormData] = useState({
    ...
    hasGradient: Boolean(initialGradient?.from && initialGradient?.to),
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const url = isEditing ? `/api/admin/traits/${initialData.id}` : "/api/admin/traits";
      ...
      setError(err?.message || "Failed to save trait");
        ...
        <div className="flex justify-end">
          ...
          >
            {isSubmitting ? (
              ...
              <>{isEditing ? "Update Trait" : "Create Trait"}</>
            )}
          </button>
        </div>
      </div>
